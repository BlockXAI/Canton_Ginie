...
const DEPLOYMENT_STATS = [
  { icon: "🚀", label: "1,240+ Contracts Deployed", change: "+18%" },
  { icon: "⚡", label: "99.9% Compilation Rate", change: "+2.1%" },
];
  ...
  return (
    ...
    >
      <div className="transition-transform duration-500 ease-out group-hover:scale-110">
        ...
        <h3 className="text-lg md:text-xl font-medium text-card-foreground/70 leading-tight mb-5">
